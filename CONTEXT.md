...
- Current package split:
  ...
  - `template_project_bringup`: launch files, config, and run helper.
...
- Docker runtime smoke verified `ros2 pkg prefix template_project_bringup` and a timeout launch of `template_project.launch.py`.
